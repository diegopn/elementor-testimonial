...
/**
 * Main Elementor Testimonial Class
 *
 * The init class that runs the Elementor Testimonial plugin.
 ...
 */
final class Elementor_Testimonial {
	...
	public function i18n() {
		load_plugin_textdomain( 'elementor-testimonial' );
	}
	...
	public function admin_notice_missing_main_plugin() {
		deactivate_plugins( plugin_basename( ELEMENTOR_TESTIMONIAL ) );
...
// Instantiate Elementor_Testimonial.
new Elementor_Testimonial();
